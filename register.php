        ...
        <section class="flex items-center px-6 py-10 sm:px-10 lg:px-16">
            <div class="mx-auto w-full max-w-md">
                ...
                <div class="rounded-lg border border-slate-200 bg-white p-6 shadow-soft sm:p-8">
                    <div class="mb-6">
                        <p class="text-sm font-bold uppercase tracking-[0.18em] text-[#545677]">Register</p>
                    ...
                    <?php if ($success): ?>
                        <div class="mb-5 rounded-lg border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm font-semibold text-emerald-700">
                            <?= e($success) ?>
                            <div class="mt-2">
                                <a href="login.php" class="font-bold underline text-emerald-900">Masuk ke aplikasi</a>
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <form method="POST" class="space-y-4">
                        <label class="block">
                            <span class="text-sm font-bold text-[#011C27]">Nama Lengkap / Toko</span>
                            <input name="nama" type="text" required class="mt-2 w-full rounded-lg border border-slate-200 bg-white px-4 py-3 text-sm font-semibold outline-none transition focus:border-[#EB9FEF] focus:ring-4 focus:ring-[#FECEE9]" placeholder="Cth: Budi Santoso">
                        </label>

                        <label class="block">
                            <span class="text-sm font-bold text-[#011C27]">Username</span>
                            <input name="username" type="text" required class="mt-2 w-full rounded-lg border border-slate-200 bg-white px-4 py-3 text-sm font-semibold outline-none transition focus:border-[#EB9FEF] focus:ring-4 focus:ring-[#FECEE9]" placeholder="budi_s">
                        </label>

                        <label class="block">
                            <span class="text-sm font-bold text-[#011C27]">Password</span>
                            <input name="password" type="password" required class="mt-2 w-full rounded-lg border border-slate-200 bg-white px-4 py-3 text-sm font-semibold outline-none transition focus:border-[#EB9FEF] focus:ring-4 focus:ring-[#FECEE9]" placeholder="Masukkan password kuat">
                        </label>
                        
                        <label class="block">
                            <span class="text-sm font-bold text-[#011C27]">Tipe Akun</span>
                            <select name="role" class="mt-2 w-full rounded-lg border border-slate-200 bg-white px-4 py-3 text-sm font-semibold outline-none transition focus:border-[#EB9FEF] focus:ring-4 focus:ring-[#FECEE9]">
                        ...
                        <button type="submit" class="inline-flex w-full mt-2 items-center justify-center gap-2 rounded-lg bg-[#011C27] px-5 py-3 text-sm font-black text-white transition hover:bg-[#03254E]">
                    ...
                    <p class="mt-6 text-center text-sm font-semibold text-[#545677]">
                        Sudah punya akun? 
                        <a href="<?= e(url_for('login.php')) ?>" class="font-black text-[#011C27] underline transition hover:text-[#EB9FEF]">Masuk di sini</a>
                    </p>
                </div>
            </div>
        </section>
